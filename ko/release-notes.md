...
## Application Service > ROLE > 릴리스 노트 { #application-service-role-release-note }
...
### 기능 추가 { #november-26-2019-added-features }
...
### 기능 추가 { #february-22-2018-added-features }
...
* [RESTful API] Role 항목 중 RoleName, RoleGroup 추가로 Role 관련 API 확장
    * 자세한 사항은 매뉴얼 참고: [링크](./api-guide/#role)
* [SDK] 1.1.7로 릴리스
...
* [RESTful API] 각 구성 요소의 리스트를 조회할 수 있는 API 추가
    ...
    * GET /role/v1.0/appkeys/{appKey}/resources: resource 리스트 조회
    	* 자세한 사항은 매뉴얼 참고: [링크](./api-guide/#resource)
    * GET /role/v1.0/appkeys/{appKey}/scopes: scope 리스트 조회
    	* 자세한 사항은 매뉴얼 참고: [링크](./api-guide/#scope)
    * GET /role/v1.0/appkeys/{appKey}/operations: operation 리스트 조회
    	* 자세한 사항은 매뉴얼 참고: [링크](./api-guide/#operation)
...
* User 목록 조회 시, 연관 관계에 있는 Role을 가진 사용자도 반환하는 옵션 추가
    * 자세한 사항은 매뉴얼 참고: [링크](./api-guide/#user)
...
* Role 상품을 이용하는 Project 간 데이터를 Migration하는 기능 추가
    * 자세한 사항은 매뉴얼 참고: [링크](./console-guide/#migration)
