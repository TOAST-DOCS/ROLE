...
### 2024. 03. 26.
#### 기능 추가
* [RESTful API] 사용자 목록 조회 API가변경되었습니다.
...
* [RESTful API] Role 항목 중 RoleName, RoleGroup 추가로 Role 관련 API가확장되었습니다.
...
### 2017. 08. 24.
#### 기능 추가
* [RESTful API] 각 구성요소의 리스트를 조회할 수 있는 API가추가되었습니다.
...
* [RESTful API] API 제약 사항이 변경되었습니다.
	* GET /role/v1.0/appkeys/{appKey}/resources/hierarchy API가user나 role 을 인자로 주지 않아도 전체 결과를 주도록 변경되었습니다.
		* 자세한 사항은 매뉴얼 참고: [링크](http://docs.nhncloud.com/ko/Application%20Service/ROLE/ko/api-guide/#4-resource)
