...
## Application Service > ROLE > 콘솔 사용 가이드 { #application-service-role-console-user-guide }

<a id="bulletin-board-example"></a>
## 게시판 예제 { #bulletin-board-example }
...
### 4) 역할-리소스 관계 생성 { #create-a-role-resource-relationship }
...
### 5) 조건 속성 생성 { #create-condition-attribute }
...
### 클라이언트 SDK 캐시 설정 { #client-sdk-cache-settings }
