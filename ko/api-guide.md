...
## Application Service > ROLE > API 가이드 { #application-service-role-api-guide }
...
|Key|	Type|	Required|	Description|
|---|---|---|---|
|scopeId|	String|	Yes|	Scope ID <br/> 최대 36글자까지 등록 가능합니다. </br> -\_ 특수문자를 사용할 수 있으며, ID의 시작과 끝은 반드시 문자 및 숫자가 와야 합니다. |
